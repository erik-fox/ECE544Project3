...
int	 do_init(void)
{
	...
	// GPIOButton channel 1 is an 16-bit output port.
	// GPIOButton channel 2 is an 16-bit output port.
	XGpio_SetDataDirection(&GPIOButton, GPIO_1_Channel_1, 0x0000);
	XGpio_SetDataDirection(&GPIOButton, GPIO_1_Channel_2, 0x0000);
...
void Switch_Update(){
	...
	//TODO REPLACE switch_values = NX4IO_getSwitches();
